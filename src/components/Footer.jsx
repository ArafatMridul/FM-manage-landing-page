...
const Footer = () => {
    ...
    return (
        <footer className="bg-neutral-g-2">
            <div className="wrapper px-6 sm:px-20 lg:px-0 pt-12 pb-8 grid lg:grid-cols-5">
                <div className="grid row-start-3 lg:row-start-1 lg:col-start-1">
                    <div className="row-start-2 lg:row-start-1 mt-14 lg:mt-3 flex items-center lg:items-start justify-center lg:justify-start">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="146"
                            height="24"
                            className="scale-[1.2] lg:scale-[1]"
                        >
                    ...
                    <div className="flex items-center justify-between lg:justify-normal lg:items-start gap-2 lg:gap-4 row-start-1 lg:row-start-2 mt-13 lg:mt-22 px-5 lg:px-2">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
                            height="20"
                            className="scale-[1.5] lg:scale-[1] hover:cursor-pointer fill-white hover:fill-primary-o transition duration-300"
                        >
                ...
                <div className="flex row-start-2 lg:row-start-1 lg:col-start-2 lg:col-span-2 mt-14 lg:mt-0 pl-10 lg:pl-0 pr-7 lg:pr-0 justify-between sm:justify-center lg:justify-start sm:gap-60">
                    <div className="grid gap-4">
                        <FooterLinks className="lg:pl-14">Home</FooterLinks>
                        <FooterLinks className="lg:pl-14">Pricing</FooterLinks>
                        <FooterLinks className="lg:pl-14">Products</FooterLinks>
                        <FooterLinks className="lg:pl-14">About Us</FooterLinks>
                    </div>
                    <div className="grid">
                ...
                <div className="flex items-center justify-center lg:justify-end lg:items-start gap-2 row-start-1 lg:row-start-1 lg:col-start-4 lg:col-span-2 lg:mt-4">
                    <div className="flex flex-col space-y-1">
                        <input
                            ...
                            className={`bg-white text-primary-o px-6 py-3 lg:w-[200px] rounded-full placeholder:text-xs placeholder:text-neutral-g-2/50 border ${
                                showError
                        ...
                        />
                        {showError && (
                            <span className="text-[0.6rem] italic text-red-700 px-2">
                                Please insert a valid email
                            </span>
                        )}
                    </div>
                    <div>
                        <Button className="bg-primary-o text-neutral-g-1 lg:px-6">
                            Go
                        </Button>
                    </div>
                </div>
                <div className="flex items-center justify-center mt-14 lg:mt-0 lg:col-start-5">
                    <p className="text-xs text-neutral-g-1/30">
